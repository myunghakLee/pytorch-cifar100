...
python train.py -net vgg11 -gpu --random_rate 0.5 --save_dir experimentsOverOverfit/vgg11_50 --multiply_epoch 10.0


# python train.py -net vgg13 -gpu --random_rate 0.0 --save_dir experimentsOverOverfit/vgg13_00 --multiply_epoch 10.0
python train.py -net vgg13 -gpu --random_rate 0.5 --save_dir experimentsOverOverfit/vgg13_50 --multiply_epoch 10.0
